...
<head>
	...
	<title>RELATÓRIO CORRENTISTAS</title>
...
<form class="ok" action="RelatorioCorrentistas" method="post">
<table border="1" width="35%" align="center">
<th><h2>RELATÓRIO POR CORRENTISTAS</h2></th>
...
<%
		...
		try{
			...
			List<NegPlanoContabil> relCor = InfraDao.Correntistas();		
	%>
</head>
<body>
	<table border="1" width="35%" align="center" cellpadding="4">
		...
		<%
			for(NegPlanoContabil objContabilidade : relCor){
		%>
		<tr>
    ...
    %>		</div>
			...
			<div align="center">
			<input align="left" id="buscar-search-btn" type="button" value="Voltar" onClick="window.open('ApresRelatorio.jsp')">
	</div>
	</div>
	</div>
