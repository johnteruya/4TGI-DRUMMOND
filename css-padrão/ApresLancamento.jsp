...
<form action="NegIncluirLancamento" method="post">
...
<!-- ENDEREÃ‡O -->
	...
	<table cellspacing="10">
		...
		<tr td align="left">
		<td td align="left">
		<label for="tipoLancamento">tipoLancamento:</label>
		</td>
		<td align="left">
		<input type="text" name="tipoLancamento">
		</td>
		</tr>
		...
		<tr td align="left">
		<td td align="left">
		<label for="produtoBancario">Produto Bancário:</label>
		</td>
		<td align="left">
		<input type="text" name="produtoBancario">
		</td>
		</tr>
...
<!--<input align="left" id="buscar-search-btn" type="button" value="Editar" onClick="window.open('ApresLancados.jsp')">-->
<input align="left" id="buscar-search-btn" type="button" value="Pesquisar" onClick="window.open('ApresLancados.jsp')">
