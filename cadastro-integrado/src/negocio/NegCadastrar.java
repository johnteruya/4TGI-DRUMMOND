...
public class NegCadastrar extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// *******converte o dado do campo data recebido do formulário em
		// string**********
		...
		double renda = ctrlConv.convertDouble(rend);
			...
			if(stats) {
				...
				out.println("<ul>");
				out.println("<li><a href=\"/Contabilidade/ApresIndex.jsp\"><span>HOME</span></a></li>");
				out.println("<li class=\"selected\"><a href=\"cadastro.jsp\"><span>CADASTRO</span></a></li>");
				out.println("<li><a href=\"/contaCorrente/menu.jsp\"><span>CONTA CORRENTE</span></a></li>");
				out.println("<li><a href=\"#\"><span>CARTÃO</span></a></li>");
				out.println("<li><a href=\"/Emprestimos/Emprestimos.jsp\"><span>EMPRÉSTIMO</span></a></li>");
				out.println("<li><a href=\"#\"><span>DEVEDORES</span></a></li>");
				out.println("<li><a href=\"/Contabilidade/ApresLancamento.jsp\"><span>CONTABILIDADE</span></a></li>");
				out.println("</ul>");
				out.println("</div>");
			...
			out.println("<h2>Situação Cadastral</h2>");
			out.println("<br>");
			out.println(" Verificar conexão do <strong>Banco de Dados</strong>!</br></br></br> ");
