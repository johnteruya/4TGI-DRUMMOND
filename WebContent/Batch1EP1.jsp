...
<div align="center" id="body">
	...
	try{
		...
		try {
			InfraDaoEP1 ifd3 = new InfraDaoEP1();
			ifd3.ManterParcelas3();
			//out.println(" ok procedure Apagar Ultimo Registro / ");
		}
		catch (Exception e) {
			//out.println("Erro Procedure Apagar Ultimo Registro:" +e);
		}
		out.println("Batch de Parcelas Executado com Sucesso");
	}
	catch (Exception e){
		out.println("Falha ao executar Batch de Parcelas");
	}
	%>
	<form method ="post">
