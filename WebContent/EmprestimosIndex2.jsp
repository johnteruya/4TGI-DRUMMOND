...
<div align="center" id="body">
	...
	<h1>OK BANK</h1>
		...
		<form method="post">
			...
			&nbsp; &nbsp;
			<input type="button" value="Batch de Parcelas" onclick="location.href = 'Batch1EP1.jsp';"/>
			&nbsp; &nbsp;
			<input type="button" value="Batch de Contratos" onclick="location.href = 'Batch2EP1.jsp';"/>
		</form>
