...
/**
 * Servlet implementation class RelatorioGeral
 */
@SuppressWarnings("serial")
@WebServlet(name = "RelatorioGeral", urlPatterns = {"/RelatorioGeral"})
...
public class RelatorioGeral extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		out.print("<h1>Relatório Geral</h1>");
				
		//Função de tratamento de erros
		try{
			//Instância o método List<NegCliente> que está em InfraDao 
			List<NegPlanoContabil> relGeral = InfraDao.Contabilidade();
			...
			out.print("<tr><th>Cod Contabil</th><th>Valor</th><th>Data</th><th>Cod Lancamento</th></tr>");
				...
				for(NegPlanoContabil objContabilidade : relGeral){
