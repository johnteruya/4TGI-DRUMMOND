...
<body>
  ...
  <p class="title">RELATÓRIOS</p>
	...
	<br>
    <input id="buscar-search-btn" align="center" type="button" value="CRÉDITO">  <br />
	<input id="buscar-search-btn" align="center" type="button" value="DÉBITO">  <br />
	<input id="buscar-search-btn" align="center" type="button" value="CARTÃO">  <br />
    <input id="buscar-search-btn" align="center" type="button" value="EMPRÉSTIMO">  <br />
    <input id="buscar-search-btn" align="center" type="button" value="DEVEDORES">  <br />
	<input id="buscar-search-btn" align="center" type="button" value="RELATÓRIO COMPLETO">  <br />
  ...
  <footer><a target="blank" href="ApresIndex.html">OK BANK</a></footer>
  </p>
</div>
